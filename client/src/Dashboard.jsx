    ...
    <div style={styles.container}>
      <div style={styles.sidebar}>
        <ul style={styles.sidebarList}>
          ...
          <li style={styles.sidebarItem}><a href='./AboutUs' style={{ textDecoration: 'none', color: 'black' }}>About Us</a></li> <br></br>  <br></br> <br></br><br></br><br></br><br></br><br></br>
              ...
              <div style={styles.forecastGrid}>
                {forecast.list.slice(0, 7).map((item, index) => (
                  <div key={index} style={styles.forecastItem}>
                    <h6><i>{new Date(item.dt_txt).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }).replace(/\//g, '/')}</i></h6>
